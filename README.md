...
- Preview button to showcase how it would look before finalizing.
...
--------------- Note: ---------------
----------------------------------------------------
I write the core code for the tool, but later used AI to re-format and add/tweak many features that were too complex to wire together.
